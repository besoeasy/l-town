...
export const CFG = {
  ...
  REGEN_DELAY: 7000,        // Receiving damage stops hull regen for 7 seconds (calm period)
  REGEN_RATE: 500,          // Instant nanite reconstruction to full hull when calm period completes
